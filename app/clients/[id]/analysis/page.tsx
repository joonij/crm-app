...
const ALLOWED_COVERAGES = [
  ...
  "일반사망 진단비", "상해사망 진단비", "질병사망 진단비", "재해사망 진단비", 
  "재해 후유장해3%↑", "상해 후유장해3%↑", "질병 후유장해3%↑", 
  "일반암 진단금", "유사암 진단금", "소액암 진단금", "항암방사선 치료비", "항암약물 치료비", "항암방사선약물 치료비", "암 수술비",
  "뇌산정특례대상 진단비", "뇌혈관질환 진단비", "심장산정특례대상 진단비", "허혈성심장질환 진단비", 
