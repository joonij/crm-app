...
import { 
  SlideIntro, SlideSection1, SlideSection2, 
  SlideSection3, SlideSection4 
} from "./components/RejectionSlides";

export default function PreSignUpTrainingPage() {
  const [currentSlide, setCurrentSlide] = useState(0);

  // 컴포넌트로 분리한 슬라이드 배열 매핑
  const slides = [
    { id: "intro", title: "", content: <SlideIntro /> },
    { id: "sec1", title: "Chapter 1. 적립보험료", content: <SlideSection1 /> },
    { id: "sec2", title: "Chapter 2. 갱신형 vs 비갱신형", content: <SlideSection2 /> },
    { id: "sec3", title: "Chapter 3. 우량담보", content: <SlideSection3 /> },
    { id: "sec4", title: "Chapter 4. 핵심 정리", content: <SlideSection4 /> }
  ];
  ...
  return (
    <div className="w-full max-w-[1400px] mx-auto p-4 md:p-8 pb-24">
      ...
      <div className="relative bg-white rounded-[2rem] border border-gray-200 shadow-2xl h-[780px] flex flex-col overflow-hidden">
        ...
        {/* 슬라이드 제목 (현재는 컴포넌트 내부에 타이틀이 있으므로 생략) */}
