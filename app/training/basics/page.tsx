...
export default function BasicsTrainingPage() {
  ...
  const slides = [
    ...
    { id: "ch2", title: "Chapter 1. 보험사는 결국 두 가지", content: <SlideCh2 /> },
    { id: "ch3", title: "Chapter 2. 손해보험사가 더 비싼 이유", content: <SlideCh3 /> },
    { id: "ch4", title: "Chapter 2. 생명보험사 vs 손해보험사, 실제 보험료 비교", content: <SlideCh4 /> },
    { id: "ch5", title: "Chapter 3. 같은 '사망'인데, 약관은 다르게 본다", content: <SlideCh5 /> },
    { id: "ch6", title: "Chapter 4. 병원에서 일어나는 일 = 보험 설계의 기준", content: <SlideCh6 /> },
    { id: "ch7", title: "Chapter 5. 진료비는 실손보험(실비)에서만 보상", content: <SlideCh7 /> },
    { id: "ch8", title: "Chapter 6. 진단비의 핵심, 3대질환", content: <SlideCh8 /> },
    { id: "ch9", title: "Chapter 7. 일반암의 '범위'를 확인하라", content: <SlideCh9 /> },
    { id: "ch10", title: "Chapter 8. 뇌혈관질환의 종류", content: <SlideCh10 /> },
    { id: "ch11", title: "Chapter 9. 심근경색 특약만으론 협심증을 놓친다", content: <SlideCh11 /> },
    { id: "ch12", title: "Chapter 10. 뇌·심혈관특약만으로는 부족하다", content: <SlideCh12 /> },
    { id: "ch13", title: "Chapter 11. 수술 보장은 두 특약이 서로를 보완한다", content: <SlideCh13 /> },
    { id: "ch14", title: "Chapter 12. 입원보험, 무리해서 가입할 필요는 없다", content: <SlideCh14 /> },
    { id: "ch15", title: "Chapter 13. 네 가지만 기억하세요", content: <SlideCh15 /> },
  ];
