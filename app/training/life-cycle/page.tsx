...
// 분리해 둔 슬라이드 컴포넌트들을 불러옵니다.
import { 
  Slide1, Slide2, Slide3, Slide4, Slide5, Slide6, 
  Slide7, Slide8, Slide9, Slide10, Slide11, Slide12 
} from "./components/LifeCycleSlides";

export default function LifeCycleTrainingPage() {
  const [currentSlide, setCurrentSlide] = useState(0);

  // 컴포넌트로 분리한 슬라이드 배열 매핑
  const slides = [
    { id: "s1", title: "", content: <Slide1 /> },
    { id: "s2", title: "Chapter 1. 라이프사이클", content: <Slide2 /> },
    { id: "s3", title: "Chapter 1. 라이프사이클", content: <Slide3 /> },
    { id: "s4", title: "Chapter 1. 라이프사이클", content: <Slide4 /> },
    { id: "s5", title: "Chapter 2. 인플레이션", content: <Slide5 /> },
    { id: "s6", title: "Chapter 3. 실사례", content: <Slide6 /> },
    { id: "s7", title: "Chapter 4. 3대 자산", content: <Slide7 /> },
    { id: "s8", title: "Chapter 5. A · B 비교", content: <Slide8 /> },
    { id: "s9", title: "Chapter 5. A · B 비교 ", content: <Slide9 /> },
    { id: "s10", title: "Chapter 6. 컨설팅의 중요성", content: <Slide10 /> },
    { id: "s11", title: "Chapter 6. 컨설팅의 중요성 ", content: <Slide11 /> },
